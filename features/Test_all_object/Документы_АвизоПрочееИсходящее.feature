...
Сценарий: Открыть и закрыть существующий объект БД (Авизо по ОС исходящее)
	Дано Я открываю основную форму списка документа "АвизоПрочееИсходящее"
	Тогда открылось окно 'Авизо прочие исходящие'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.АвизоПрочееИсходящее.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Авизо прочие исходящие'
