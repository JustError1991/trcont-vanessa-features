...
Сценарий: Открыть и закрыть существующий объект БД (Прочие операции: авизо, возвраты, перемещения (ИРС))
	Дано Я открываю основную форму списка документа "МТ_ПрочиеОперацииАвизоВозвратыПеремещенияЛСИРС"
	Тогда открылось окно 'Прочие операции: авизо, возвраты, перемещения (ИРС)'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.МТ_ПрочиеОперацииАвизоВозвратыПеремещенияЛСИРС.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Прочие операции: авизо, возвраты, перемещения (ИРС)'
