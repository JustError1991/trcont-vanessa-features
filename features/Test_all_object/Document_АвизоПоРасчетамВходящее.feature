...
Сценарий: Открыть и закрыть существующий объект БД (Авизо по расчетам исходящие)
	...
	Тогда открылось окно 'Авизо по расчетам входящие'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.АвизоРасчетыВходящее.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Авизо по расчетам входящие'
