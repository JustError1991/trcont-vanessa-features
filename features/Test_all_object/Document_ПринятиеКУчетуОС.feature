...
Сценарий: Открыть и закрыть существующий объект БД (Принятие К Учету ОС)
//	Дано Я открываю основную форму списка документа "ПринятиеКУчетуОС"
//	Тогда открылось окно 'Принятие к учету ОС'
//	И Пауза 2
...
//	Тогда открылась форма с именем "Документ.ПринятиеКУчетуОС.Форма.ФормаДокумента"
...
//	И Я закрываю окно 'Принятие к учету ОС'
