...
Сценарий: Открыть и закрыть существующий объект БД (Авизо по ОС входящее)
	Дано Я открываю основную форму списка документа "АвизоОСВходящее"
	Тогда открылось окно 'Авизо по ОС входящие'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.АвизоОСВходящее.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Авизо по ОС входящие'
