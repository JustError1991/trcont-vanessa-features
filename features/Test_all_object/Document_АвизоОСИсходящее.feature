...
Сценарий: Открыть и закрыть существующий объект БД (Авизо по ОС исходящее)
	...
	Тогда открылось окно 'Авизо по ОС исходящие'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.АвизоОСИсходящее.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Авизо по ОС исходящие'
