...
Сценарий: Открыть и закрыть существующий объект БД (Комплект документов по ремонту вагона (ТК))
	Дано Я открываю основную форму списка документа "ТК_ВагТК_КомплектПоРемонтуВагона"
	Тогда открылось окно 'Комплект документов по ремонту вагона (ТК)'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.ТК_ВагТК_КомплектПоРемонтуВагона.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Комплект документов по ремонту вагона (ТК)'
