...
Сценарий: Открыть и закрыть существующий объект БД (Авизо по МПЗ Исходящее)
	Дано Я открываю основную форму списка документа "АвизоМПЗИсходящее"
	Тогда открылось окно 'Авизо по МПЗ исходящие'
	И Пауза 2
	...
	Тогда открылась форма с именем "Документ.АвизоМПЗИсходящее.Форма.ФормаДокумента"
	...
	И Я закрываю окно 'Авизо по МПЗ исходящие'
